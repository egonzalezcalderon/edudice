...
@NamedStoredProcedureQuery(
	name = "insertarRemitoDefinitivo", 
	procedureName = "SP_PROV_REMITOS_DEF_INSERT", 
	resultClasses = {InsertRemitoDefinitivoDto.class}, 
	parameters = {   
...
public class InsertRemitoDefinitivoDto extends TransformableDto<LawWSInputBo> implements Serializable {
