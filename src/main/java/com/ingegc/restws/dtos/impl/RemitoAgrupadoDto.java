...
@NamedStoredProcedureQuery(
	name = "consultaRemitosAgrupados", 
	procedureName = "SP_PROV_REMITOS_AGRUP", 
	resultClasses = {RemitoAgrupadoDto.class}, 
	parameters = {     
...
public class RemitoAgrupadoDto extends TransformableDto<RemitoAgrupadoBo> implements Serializable {
    ...
    @Override
    public RemitoAgrupadoBo translate() {
        return translate(new RemitoAgrupadoBo());
    }       
}