...
@NamedStoredProcedureQuery(
	name = "consultaReordersExportProv", 
	procedureName = "SP_PROV_REORDER_EXPORT_SELPROV", 
	resultClasses = {ReorderExportProvDto.class}, 
	parameters = {     
...
public class ReorderExportProvDto extends TransformableDto<ReorderExportProvBo> implements Serializable {
        ...
        @Override
        public ReorderExportProvBo translate() {
            ReorderExportProvBo reorder = translate(new ReorderExportProvBo());
