...
@NamedStoredProcedureQuery(
	name = "consultaFechasRemitos", 
	procedureName = "SP_PROV_REMITOS_FECHAS", 
	resultClasses = {FechaRemitosDto.class}, 
	parameters = {     
...
public class FechaRemitosDto extends TransformableDto<LawWSDateBo> implements Serializable {
