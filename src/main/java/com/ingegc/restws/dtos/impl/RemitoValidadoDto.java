...
@NamedStoredProcedureQuery(
	name = "consultaRemitosValidados", 
	procedureName = "SP_PROV_REMITOS_DEF_VALIDADOS", 
	resultClasses = {RemitoValidadoDto.class}, 
	parameters = {     
            @StoredProcedureParameter(name="p_idproveedor", type = String.class, mode = ParameterMode.IN),
            @StoredProcedureParameter(name="p_desde", type = Date.class, mode = ParameterMode.IN),
            @StoredProcedureParameter(name="p_hasta", type = Date.class, mode = ParameterMode.IN),
            @StoredProcedureParameter(name="p_cursor", mode = ParameterMode.REF_CURSOR, type = void.class)
	}
)
public class RemitoValidadoDto extends TransformableDto<RemitoValidadoBo> implements Serializable {
    ...
    @Override
    public RemitoValidadoBo translate() {
        RemitoValidadoBo remito = translate(new RemitoValidadoBo());
        return remito;
    }
