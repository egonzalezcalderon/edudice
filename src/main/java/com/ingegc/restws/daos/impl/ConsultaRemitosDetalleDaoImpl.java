 ...
 */
@Repository
public class ConsultaRemitosDetalleDaoImpl extends LawWSDao {
    
    public List<RemitoDetalleDto> getRemitosDetalle(String idProveedor, Date fecha) {
        StoredProcedureQuery spQuery = createStoreProcedureQuery("consultaRemitosDetalle");
