 ...
 */
@Repository
public class ConsultaReordersExportVWDaoImpl extends LawWSDao {
    
    public List<ReorderExportVWDto> getExportVWReorders(String idProveedor, Date fecha) {
        StoredProcedureQuery spQuery = createStoreProcedureQuery("consultaReordersExportVW");
